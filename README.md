# Lastochka Server (Tinode Fork)

This repository is the **Lastochka Messenger server**, based on the upstream **Tinode chat server**.

- Upstream project: https://github.com/tinode/chat
- Upstream authors and copyright holders retain rights to their work.
- This fork contains project-specific development for the Lastochka ecosystem.

If you need generic Tinode behavior or upstream documentation, see the original Tinode repository.
